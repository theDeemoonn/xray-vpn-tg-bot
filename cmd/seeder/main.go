...
func seedFAQs(ctx context.Context, collection *mongo.Collection, logger *slog.Logger) error {
	...
	faqs := []domain.FAQ{
		...
		{
			Category:  "Общие вопросы",
			Question:  "Можно ли использовать один аккаунт VPN на нескольких устройствах одновременно?",
			Answer:    "Да, вы можете использовать вашу конфигурацию VPN (полученную по ссылке или QR-коду) на нескольких устройствах одновременно (например, телефон, планшет, ноутбук).\nОднако, если у вас тарифный план с ограничением трафика, помните, что трафик со всех устройств будет суммироваться и учитываться в общем лимите вашего тарифа.\nНа безлимитных тарифах количество устройств не ограничено.",
			IsActive:  true,
			SortOrder: 15,
			CreatedAt: now,
			UpdatedAt: now,
		},
		{
			...
			Question:  "Что произойдет, когда закончится трафик на моем тарифе?",
			Answer:    "Если ваш тарифный план имеет ограничение по трафику (например, 50 ГБ), то после исчерпания этого лимита доступ в интернет через VPN будет приостановлен до окончания срока действия подписки или до покупки нового тарифного плана.\nВы получите уведомление в боте о приближении к лимиту. Вы всегда можете проверить остаток трафика в разделе '🚀 Мои подписки'.\nЧтобы продолжить пользоваться VPN, вам нужно будет приобрести новый тариф.",
			IsActive:  true,
			SortOrder: 30,
			CreatedAt: now,
			UpdatedAt: now,
		...
		{
			Category:  "Технические вопросы",
			Question:  "Как выбрать лучший сервер для подключения?",
			Answer:    "Выбор сервера зависит от вашего местоположения и цели использования VPN.\nКак правило, серверы, географически расположенные ближе к вам, обеспечивают более низкую задержку (пинг) и потенциально более высокую скорость.\nЕсли вам нужен IP-адрес конкретной страны, выбирайте сервер в этой стране.\nЕсли вы испытываете проблемы со скоростью или доступностью на одном сервере, попробуйте переключиться на другой доступный сервер в разделе '⚙️ Настроить сервер'.",
			IsActive:  true,
			SortOrder: 30,
			CreatedAt: now,
			UpdatedAt: now,
	...
	instructions := []domain.Instruction{
		{
			...
			Content:   "📥 Скачать: https://play.google.com/store/apps/details?id=com.v2ray.ang или https://github.com/2dust/v2rayNG/releases\n\n1. Скопируйте ссылку на конфигурацию, начинающуюся с 'vless://...'\n2. Откройте V2RayNG.\n3. Нажмите на значок плюса в правом верхнем углу.\n4. Выберите 'Import config from Clipboard'.\n5. Нажмите на серый кружок V внизу справа для подключения.",
			Platform:  "Android",
			IsActive:  true,
			SortOrder: 10,
			CreatedAt: now,
		...
		{
			Title:     "NekoBox и NekoRay для Windows и Linux",
			Content:   "📥 Скачать: https://github.com/MatsuriDayo/nekoray/releases\n\n1. Скопируйте ссылку на конфигурацию, начинающуюся с 'vless://...'\n2. Откройте NekoBox или NekoRay.\n3. В главном окне нажмите Ctrl и V, чтобы импортировать конфигурацию из буфера обмена.\n4. Убедитесь, что выбран режим 'VPN Mode' или 'Tun Mode' в зависимости от вашей системы.\n5. Выберите импортированный профиль и нажмите Enter или кнопку подключения.",
		...
		{
			Title:     "NekoRay и NekoBox для macOS",
			Content:   "📥 Скачать: https://github.com/MatsuriDayo/nekoray/releases\n\n1. Скачайте последнюю версию NekoRay или NekoBox для macOS с официального GitHub.\n2. Установите приложение, перетащив его в папку \"Программы\".\n3. Скопируйте полную ссылку на конфигурацию, начинающуюся с 'vless://...' из сообщения бота.\n4. Откройте NekoRay или NekoBox.\n5. Нажмите Cmd и V или перейдите в меню Server, затем Add profile from clipboard, чтобы импортировать конфигурацию из буфера обмена.\n6. В настройках программы проверьте, что выбран режим TUN. Возможно, потребуется установить системное расширение при первом запуске TUN режима.\n7. В главном окне выберите импортированный профиль.\n8. Нажмите Enter или кнопку запуска для подключения.",
			Platform:  "macOS",
			IsActive:  true,
			SortOrder: 10,
			CreatedAt: now,
		...
		{
			Title:     "FoXray для Android",
			Content:   "📥 Скачать: https://github.com/FoxieFern/FoXray/releases или https://play.google.com/store/apps/details?id=io.foxsie.foxray\n\n1. Установите приложение FoXray из Google Play или другого надежного источника.\n2. Скопируйте ссылку на конфигурацию VLESS, начинающуюся с 'vless://...' из сообщения бота.\n3. Откройте FoXray.\n4. Перейдите на вкладку 'Подписки'.\n5. Нажмите на значок плюса в правом верхнем углу.\n6. Выберите 'Добавить из буфера обмена'. Конфигурация должна импортироваться автоматически.\n7. Перейдите на вкладку 'Главная'.\n8. Нажмите на круглую кнопку внизу экрана для запуска VPN соединения. При первом подключении система может запросить разрешение на создание VPN соединения.",
			Platform:  "Android",
			IsActive:  true,
			SortOrder: 20, // After V2RayNG
			CreatedAt: now,
			UpdatedAt: now,
		},
		{
			Title:     "Sing-box для Android",
			Content:   "📥 Скачать: https://github.com/SagerNet/sing-box/releases или https://play.google.com/store/apps/details?id=io.nekohasekai.sfa\n\n1. Установите приложение Sing-box для Android.\n2. Скопируйте ссылку на конфигурацию, начинающуюся с 'vless://...'\n3. Откройте приложение Sing-box.\n4. Нажмите на значок плюса для добавления нового профиля.\n5. Выберите 'Импорт из буфера обмена' или 'Новая подписка'.\n6. Вставьте скопированную ссылку и сохраните.\n7. Активируйте профиль, нажав на кнопку подключения в главном экране.\n8. Подтвердите запрос на создание VPN соединения при первом подключении.",
			Platform:  "Android",
			IsActive:  true,
			SortOrder: 30,
			CreatedAt: now,
		...
		{
			Title:     "Surfboard для Android",
			Content:   "📥 Скачать: https://play.google.com/store/apps/details?id=com.getsurfboard\n\n1. Установите приложение Surfboard из Google Play.\n2. Скопируйте ссылку на конфигурацию, начинающуюся с 'vless://...'\n3. Откройте Surfboard.\n4. Перейдите в раздел 'Профили'.\n5. Нажмите на значок плюса в правом верхнем углу.\n6. Выберите 'Из буфера обмена'.\n7. После успешного импорта профиля вернитесь на главный экран и нажмите кнопку подключения.\n8. При первом запуске подтвердите создание VPN соединения.",
			Platform:  "Android",
			IsActive:  true,
			SortOrder: 40,
			CreatedAt: now,
		...
		{
			Title:     "Kitsunebi для iOS",
			Content:   "📥 Скачать: https://apps.apple.com/app/kitsunebi-proxy-utility/id1446584073\n\n1. Скопируйте ссылку на конфигурацию, начинающуюся с 'vless://...'\n2. Откройте приложение Kitsunebi.\n3. Перейдите на вкладку 'Профили'.\n4. Нажмите на значок плюса в верхнем правом углу.\n5. Выберите 'Импорт из буфера обмена'.\n6. После добавления профиля вернитесь на главный экран и включите переключатель для активации VPN.",
			Platform:  "iOS",
			IsActive:  true,
			SortOrder: 30,
			CreatedAt: now,
