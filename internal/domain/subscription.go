...
type Subscription struct {
	...
	XuiClientUID  string             `bson:"xui_client_uid" json:"xui_client_uid"`   // Client identifier (usually Email) in x-ui
	XuiClientUUID string             `bson:"xui_client_uuid" json:"xui_client_uuid"` // Client UUID in x-ui (for VLESS/VMESS/etc.)
...
// SubscriptionDetails содержит подробную информацию о подписке для отображения
